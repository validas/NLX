 ...
 * </p>
 * <ul>
 *   <li>{@link de.validas.vvt.impl.ParameterValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterValueImpl extends MinimalEObjectImpl.Container implements ParameterValue {
	...
	protected EClass eStaticClass() {
		return VvtPackage.Literals.PARAMETER_VALUE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VvtPackage.PARAMETER_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case VvtPackage.PARAMETER_VALUE__VALUE:
			return getValue();
		}
