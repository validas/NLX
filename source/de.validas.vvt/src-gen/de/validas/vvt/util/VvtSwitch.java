 ...
 * @generated
 */
public class VvtSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VvtPackage.REPOSITORY: {
			...
			if (result == null)
				result = caseDescribed(repository);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case VvtPackage.CHECK_RESULT: {
			CheckResult checkResult = (CheckResult) theEObject;
			T result = caseCheckResult(checkResult);
			if (result == null)
				result = caseDescribed(checkResult);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case VvtPackage.PARAMETER: {
			...
			if (result == null)
				result = caseDescribed(parameter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Check Result</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Check Result</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCheckResult(CheckResult object) {
		return null;
	}
