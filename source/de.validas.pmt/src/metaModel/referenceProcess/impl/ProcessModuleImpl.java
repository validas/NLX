...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Process Module</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getVerifiedBy <em>Verified By</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getVerifies <em>Verifies</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getRequirements <em>Requirements</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getSubProcessModules <em>Sub Process Modules</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getInputArtifacts <em>Input Artifacts</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getTools <em>Tools</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getBeforeProcessModules <em>Before Process Modules</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getAfterProcessModules <em>After Process Modules</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getInvolvedStakeHolders <em>Involved Stake Holders</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getPreMMCondition <em>Pre MM Condition</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getPostMMCondition <em>Post MM Condition</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getOutputArtifacts <em>Output Artifacts</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getURI <em>URI</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getBindings <em>Bindings</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getNumberOfInstances <em>Number Of Instances</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getEffort <em>Effort</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getProgress <em>Progress</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getPlannedStartDate <em>Planned Start Date</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getPlannedEndDate <em>Planned End Date</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getSubProcessModuleReferences <em>Sub Process Module References</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getInstanceOfProcessModule <em>Instance Of Process Module</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getInstantiatedInProcessModules <em>Instantiated In Process Modules</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getCompliances <em>Compliances</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getStakeHolder <em>Stake Holder</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getClaimedComplianceRequirements <em>Claimed Compliance Requirements</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getParameterReferences <em>Parameter References</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getDeterminedVariables <em>Determined Variables</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getLayout <em>Layout</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getArtifacts <em>Artifacts</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getStakeHolders <em>Stake Holders</em>}</li>
 *   <li>{@link metaModel.referenceProcess.impl.ProcessModuleImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessModuleImpl extends VariantableImpl implements ProcessModule {
	/**
	...
	protected EClass eStaticClass() {
		return ReferenceProcessPackage.Literals.PROCESS_MODULE;
	}
	...
	public EList<IVerifier> getVerifiedBy() {
		if (verifiedBy == null) {
			verifiedBy = new EObjectWithInverseResolvingEList.ManyInverse<IVerifier>(IVerifier.class, this, ReferenceProcessPackage.PROCESS_MODULE__VERIFIED_BY, ReferenceProcessPackage.IVERIFIER__VERIFIES);
		}
		return verifiedBy;
	}
	...
	public EList<IVerified> getVerifies() {
		if (verifies == null) {
			verifies = new EObjectWithInverseResolvingEList.ManyInverse<IVerified>(IVerified.class, this, ReferenceProcessPackage.PROCESS_MODULE__VERIFIES, ReferenceProcessPackage.IVERIFIED__VERIFIED_BY);
		}
		return verifies;
	}
	...
	public EList<Requirement> getRequirements() {
		if (requirements == null) {
			requirements = new EObjectResolvingEList<Requirement>(Requirement.class, this, ReferenceProcessPackage.PROCESS_MODULE__REQUIREMENTS);
		}
		return requirements;
	}
	...
	public EList<ProcessModule> getSubProcessModules() {
		if (subProcessModules == null) {
			subProcessModules = new EObjectContainmentEList<ProcessModule>(ProcessModule.class, this, ReferenceProcessPackage.PROCESS_MODULE__SUB_PROCESS_MODULES);
		}
	...
	public EList<Artifact> getInputArtifacts() {
		if (inputArtifacts == null) {
			inputArtifacts = new EObjectWithInverseResolvingEList.ManyInverse<Artifact>(Artifact.class, this, ReferenceProcessPackage.PROCESS_MODULE__INPUT_ARTIFACTS, ReferenceProcessPackage.ARTIFACT__READ_BY_PROCESS_MODULES);
		}
	...
	public EList<Tool> getTools() {
		if (tools == null) {
			tools = new EObjectWithInverseResolvingEList.ManyInverse<Tool>(Tool.class, this, ReferenceProcessPackage.PROCESS_MODULE__TOOLS, ReferenceProcessPackage.TOOL__PROCESS_MODULES);
		}
		return tools;
	}
	...
	public EList<ProcessModule> getBeforeProcessModules() {
		if (beforeProcessModules == null) {
			beforeProcessModules = new EObjectWithInverseResolvingEList.ManyInverse<ProcessModule>(ProcessModule.class, this, ReferenceProcessPackage.PROCESS_MODULE__BEFORE_PROCESS_MODULES, ReferenceProcessPackage.PROCESS_MODULE__AFTER_PROCESS_MODULES);
		}
	...
	public EList<ProcessModule> getAfterProcessModules() {
		if (afterProcessModules == null) {
			afterProcessModules = new EObjectWithInverseResolvingEList.ManyInverse<ProcessModule>(ProcessModule.class, this, ReferenceProcessPackage.PROCESS_MODULE__AFTER_PROCESS_MODULES, ReferenceProcessPackage.PROCESS_MODULE__BEFORE_PROCESS_MODULES);
		}
	...
	public EList<StakeHolder> getInvolvedStakeHolders() {
		if (involvedStakeHolders == null) {
			involvedStakeHolders = new EObjectWithInverseResolvingEList.ManyInverse<StakeHolder>(StakeHolder.class, this, ReferenceProcessPackage.PROCESS_MODULE__INVOLVED_STAKE_HOLDERS, ReferenceProcessPackage.STAKE_HOLDER__INVOLVED_MODULES);
		}
	...
	public NotificationChain basicSetPreMMCondition(MMCondition newPreMMCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__PRE_MM_CONDITION, oldPreMMCondition, newPreMMCondition);
	...
	public void setPreMMCondition(MMCondition newPreMMCondition) {
		if (newPreMMCondition != preMMCondition) {
			...
			if (preMMCondition != null)
				msgs = ((InternalEObject)preMMCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReferenceProcessPackage.PROCESS_MODULE__PRE_MM_CONDITION, null, msgs);
			if (newPreMMCondition != null)
				msgs = ((InternalEObject)newPreMMCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReferenceProcessPackage.PROCESS_MODULE__PRE_MM_CONDITION, null, msgs);
			msgs = basicSetPreMMCondition(newPreMMCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__PRE_MM_CONDITION, newPreMMCondition, newPreMMCondition));
	}
	...
	public NotificationChain basicSetPostMMCondition(MMCondition newPostMMCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__POST_MM_CONDITION, oldPostMMCondition, newPostMMCondition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPostMMCondition(MMCondition newPostMMCondition) {
		if (newPostMMCondition != postMMCondition) {
			...
			if (postMMCondition != null)
				msgs = ((InternalEObject)postMMCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ReferenceProcessPackage.PROCESS_MODULE__POST_MM_CONDITION, null, msgs);
			if (newPostMMCondition != null)
				msgs = ((InternalEObject)newPostMMCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ReferenceProcessPackage.PROCESS_MODULE__POST_MM_CONDITION, null, msgs);
			msgs = basicSetPostMMCondition(newPostMMCondition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__POST_MM_CONDITION, newPostMMCondition, newPostMMCondition));
	}
	...
	public EList<Artifact> getOutputArtifacts() {
		if (outputArtifacts == null) {
			outputArtifacts = new EObjectWithInverseResolvingEList.ManyInverse<Artifact>(Artifact.class, this, ReferenceProcessPackage.PROCESS_MODULE__OUTPUT_ARTIFACTS, ReferenceProcessPackage.ARTIFACT__CREATED_BY_PROCESS_MODULES);
		}
	...
	public void setURI(String newURI) {
		...
		uri = newURI;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__URI, oldURI, uri));
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Parameter>(Parameter.class, this, ReferenceProcessPackage.PROCESS_MODULE__PARAMETERS);
		}
		return parameters;
	}
	...
	public EList<Binding> getBindings() {
		if (bindings == null) {
			bindings = new EObjectContainmentEList<Binding>(Binding.class, this, ReferenceProcessPackage.PROCESS_MODULE__BINDINGS);
		}
		return bindings;
	}
	...
	public void setNumberOfInstances(int newNumberOfInstances) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__NUMBER_OF_INSTANCES, oldNumberOfInstances, numberOfInstances));
	}
	...
	public void setEffort(float newEffort) {
		...
		effort = newEffort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__EFFORT, oldEffort, effort));
	}
	...
	public void setProgress(float newProgress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__PROGRESS, oldProgress, progress));
	}
	...
	public void setPlannedStartDate(String newPlannedStartDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__PLANNED_START_DATE, oldPlannedStartDate, plannedStartDate));
	}
	...
	public void setPlannedEndDate(String newPlannedEndDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__PLANNED_END_DATE, oldPlannedEndDate, plannedEndDate));
	}
	...
	public void setEndDate(String newEndDate) {
		...
		endDate = newEndDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__END_DATE, oldEndDate, endDate));
	}
	...
	public EList<ProcessModule> getSubProcessModuleReferences() {
		if (subProcessModuleReferences == null) {
			subProcessModuleReferences = new EObjectResolvingEList<ProcessModule>(ProcessModule.class, this, ReferenceProcessPackage.PROCESS_MODULE__SUB_PROCESS_MODULE_REFERENCES);
		}
	...
	public ProcessModule getInstanceOfProcessModule() {
		if (instanceOfProcessModule != null && instanceOfProcessModule.eIsProxy()) {
			...
			if (instanceOfProcessModule != oldInstanceOfProcessModule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReferenceProcessPackage.PROCESS_MODULE__INSTANCE_OF_PROCESS_MODULE, oldInstanceOfProcessModule, instanceOfProcessModule));
			}
		}
	...
	public NotificationChain basicSetInstanceOfProcessModule(ProcessModule newInstanceOfProcessModule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__INSTANCE_OF_PROCESS_MODULE, oldInstanceOfProcessModule, newInstanceOfProcessModule);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInstanceOfProcessModule(ProcessModule newInstanceOfProcessModule) {
		if (newInstanceOfProcessModule != instanceOfProcessModule) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__INSTANCE_OF_PROCESS_MODULE, newInstanceOfProcessModule, newInstanceOfProcessModule));
	}
	...
	public EList<ProcessModule> getInstantiatedInProcessModules() {
		if (instantiatedInProcessModules == null) {
			instantiatedInProcessModules = new EObjectWithInverseResolvingEList<ProcessModule>(ProcessModule.class, this, ReferenceProcessPackage.PROCESS_MODULE__INSTANTIATED_IN_PROCESS_MODULES, ReferenceProcessPackage.PROCESS_MODULE__INSTANCE_OF_PROCESS_MODULE);
		}
	...
	public EList<Compliance> getCompliances() {
		if (compliances == null) {
			compliances = new EObjectWithInverseResolvingEList.ManyInverse<Compliance>(Compliance.class, this, ReferenceProcessPackage.PROCESS_MODULE__COMPLIANCES, ReferenceProcessPackage.COMPLIANCE__PROCESS_MODULES);
		}
		return compliances;
	}
	...
	public StakeHolder getStakeHolder() {
		if (stakeHolder != null && stakeHolder.eIsProxy()) {
			...
			if (stakeHolder != oldStakeHolder) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ReferenceProcessPackage.PROCESS_MODULE__STAKE_HOLDER, oldStakeHolder, stakeHolder));
			}
		}
		return stakeHolder;
	}
	...
	public NotificationChain basicSetStakeHolder(StakeHolder newStakeHolder, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__STAKE_HOLDER, oldStakeHolder, newStakeHolder);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStakeHolder(StakeHolder newStakeHolder) {
		if (newStakeHolder != stakeHolder) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__STAKE_HOLDER, newStakeHolder, newStakeHolder));
	}
	...
	public EList<Requirement> getClaimedComplianceRequirements() {
		if (claimedComplianceRequirements == null) {
			claimedComplianceRequirements = new EObjectWithInverseResolvingEList.ManyInverse<Requirement>(Requirement.class, this, ReferenceProcessPackage.PROCESS_MODULE__CLAIMED_COMPLIANCE_REQUIREMENTS, ReferenceProcessPackage.REQUIREMENT__CLAIMING_PROCESS_MODULES);
		}
	...
	public void setStatus(ProcessStatus newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__STATUS, oldStatus, status));
	}
	...
	public EList<Parameter> getParameterReferences() {
		if (parameterReferences == null) {
			parameterReferences = new EObjectWithInverseResolvingEList.ManyInverse<Parameter>(Parameter.class, this, ReferenceProcessPackage.PROCESS_MODULE__PARAMETER_REFERENCES, TermsPackage.PARAMETER__REUSING_PROCESS_MODULES);
		}
	...
	public EList<ProcessVariable> getDeterminedVariables() {
		if (determinedVariables == null) {
			determinedVariables = new EObjectWithInverseResolvingEList.ManyInverse<ProcessVariable>(ProcessVariable.class, this, ReferenceProcessPackage.PROCESS_MODULE__DETERMINED_VARIABLES, TermsPackage.PROCESS_VARIABLE__DETERMINED_BY_PROCESS_MODULES);
		}
	...
	public void setLayout(Layout newLayout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReferenceProcessPackage.PROCESS_MODULE__LAYOUT, oldLayout, layout));
	}
	...
	public EList<Artifact> getArtifacts() {
		if (artifacts == null) {
			artifacts = new EObjectContainmentEList<Artifact>(Artifact.class, this, ReferenceProcessPackage.PROCESS_MODULE__ARTIFACTS);
		}
		return artifacts;
	}
	...
	public EList<StakeHolder> getStakeHolders() {
		if (stakeHolders == null) {
			stakeHolders = new EObjectContainmentEList<StakeHolder>(StakeHolder.class, this, ReferenceProcessPackage.PROCESS_MODULE__STAKE_HOLDERS);
		}
		return stakeHolders;
	}
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, ReferenceProcessPackage.PROCESS_MODULE__TYPES);
		}
		return types;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ReferenceProcessPackage.PROCESS_MODULE__SUB_PROCESS_MODULES:
			...
			case ReferenceProcessPackage.PROCESS_MODULE__PRE_MM_CONDITION:
				return basicSetPreMMCondition(null, msgs);
			case ReferenceProcessPackage.PROCESS_MODULE__POST_MM_CONDITION:
				return basicSetPostMMCondition(null, msgs);
			case ReferenceProcessPackage.PROCESS_MODULE__OUTPUT_ARTIFACTS:
				return ((InternalEList<?>)getOutputArtifacts()).basicRemove(otherEnd, msgs);
			case ReferenceProcessPackage.PROCESS_MODULE__PARAMETERS:
				return ((InternalEList<?>)getParameters()).basicRemove(otherEnd, msgs);
			case ReferenceProcessPackage.PROCESS_MODULE__BINDINGS:
			...
			case ReferenceProcessPackage.PROCESS_MODULE__ARTIFACTS:
				return ((InternalEList<?>)getArtifacts()).basicRemove(otherEnd, msgs);
			case ReferenceProcessPackage.PROCESS_MODULE__STAKE_HOLDERS:
				return ((InternalEList<?>)getStakeHolders()).basicRemove(otherEnd, msgs);
			case ReferenceProcessPackage.PROCESS_MODULE__TYPES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ReferenceProcessPackage.PROCESS_MODULE__VERIFIES:
				return getVerifies();
			case ReferenceProcessPackage.PROCESS_MODULE__REQUIREMENTS:
			...
			case ReferenceProcessPackage.PROCESS_MODULE__URI:
				return getURI();
			case ReferenceProcessPackage.PROCESS_MODULE__PARAMETERS:
				return getParameters();
			case ReferenceProcessPackage.PROCESS_MODULE__BINDINGS:
				return getBindings();
			case ReferenceProcessPackage.PROCESS_MODULE__NUMBER_OF_INSTANCES:
				return getNumberOfInstances();
			case ReferenceProcessPackage.PROCESS_MODULE__EFFORT:
				return getEffort();
			case ReferenceProcessPackage.PROCESS_MODULE__PROGRESS:
				return getProgress();
			case ReferenceProcessPackage.PROCESS_MODULE__PLANNED_START_DATE:
				return getPlannedStartDate();
			case ReferenceProcessPackage.PROCESS_MODULE__PLANNED_END_DATE:
				return getPlannedEndDate();
			case ReferenceProcessPackage.PROCESS_MODULE__END_DATE:
				return getEndDate();
			case ReferenceProcessPackage.PROCESS_MODULE__SUB_PROCESS_MODULE_REFERENCES:
			...
			case ReferenceProcessPackage.PROCESS_MODULE__STATUS:
				return getStatus();
			case ReferenceProcessPackage.PROCESS_MODULE__PARAMETER_REFERENCES:
				return getParameterReferences();
			case ReferenceProcessPackage.PROCESS_MODULE__DETERMINED_VARIABLES:
				return getDeterminedVariables();
			case ReferenceProcessPackage.PROCESS_MODULE__LAYOUT:
				return getLayout();
			case ReferenceProcessPackage.PROCESS_MODULE__ARTIFACTS:
				return getArtifacts();
			case ReferenceProcessPackage.PROCESS_MODULE__STAKE_HOLDERS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == IVerified.class) {
			switch (derivedFeatureID) {
				case ReferenceProcessPackage.PROCESS_MODULE__VERIFIED_BY: return ReferenceProcessPackage.IVERIFIED__VERIFIED_BY;
				default: return -1;
			}
		}
		if (baseClass == IVerifier.class) {
			switch (derivedFeatureID) {
				case ReferenceProcessPackage.PROCESS_MODULE__VERIFIES: return ReferenceProcessPackage.IVERIFIER__VERIFIES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == IVerified.class) {
			switch (baseFeatureID) {
				case ReferenceProcessPackage.IVERIFIED__VERIFIED_BY: return ReferenceProcessPackage.PROCESS_MODULE__VERIFIED_BY;
				default: return -1;
			}
		}
		if (baseClass == IVerifier.class) {
			switch (baseFeatureID) {
				case ReferenceProcessPackage.IVERIFIER__VERIFIES: return ReferenceProcessPackage.PROCESS_MODULE__VERIFIES;
				default: return -1;
			}
		}
