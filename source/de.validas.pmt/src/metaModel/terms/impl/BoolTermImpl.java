 ...
 * </p>
 * <ul>
 *   <li>{@link metaModel.terms.impl.BoolTermImpl#getTerms <em>Terms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BoolTermImpl extends TermImpl implements BoolTerm {
	...
	protected EClass eStaticClass() {
		return TermsPackage.Literals.BOOL_TERM;
	}
	...
	public EList<Term> getTerms() {
		if (terms == null) {
			terms = new EObjectContainmentEList<Term>(Term.class, this, TermsPackage.BOOL_TERM__TERMS);
		}
		return terms;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TermsPackage.BOOL_TERM__TERMS:
