 ...
 * </p>
 * <ul>
 *   <li>{@link metaModel.terms.impl.ListTermImpl#getTerms <em>Terms</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListTermImpl extends TermImpl implements ListTerm {
	...
	public EList<Term> getTerms() {
		if (terms == null) {
			terms = new EObjectContainmentEList<Term>(Term.class, this, TermsPackage.LIST_TERM__TERMS);
		}
		return terms;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TermsPackage.LIST_TERM__TERMS:
