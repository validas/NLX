...
import de.validas.pmt.utils.TermUtils;
 ...
 * </p>
 * <ul>
 *   <li>{@link metaModel.terms.impl.TermImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TermImpl extends MinimalEObjectImpl.Container implements Term {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TermsPackage.TERM__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public String toString() {
		return TermUtils.printTerm(this);
	}
} //TermImpl
