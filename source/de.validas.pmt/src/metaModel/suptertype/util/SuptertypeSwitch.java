 ...
 * @generated
 */
public class SuptertypeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SuptertypePackage.VARIANTABLE: {
				Variantable variantable = (Variantable)theEObject;
				T result = caseVariantable(variantable);
				if (result == null) result = caseNamed(variantable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
