 ...
 * </p>
 * <ul>
 *   <li>{@link metaModel.impl.WorkaroundImpl#getIssue <em>Issue</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkaroundImpl extends MinimalEObjectImpl.Container implements Workaround {
	/**
	...
	protected EClass eStaticClass() {
		return MetaModelPackage.Literals.WORKAROUND;
	}
	...
	public void setIssue(String newIssue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaModelPackage.WORKAROUND__ISSUE, oldIssue, issue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetaModelPackage.WORKAROUND__ISSUE:
				return getIssue();
		}
